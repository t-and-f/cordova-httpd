...
public class XAPKDownloaderActivity extends Activity implements IDownloaderClient {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    try {
      ...
      int startResult = XAPKDownloaderService.startDownloadServiceIfRequired(this, "", pendingIntent, service.getSALT(),
  ...
  public void onDownloadStateChanged(int newState) {
    ...
    if ((newState == STATE_IDLE) || (newState == STATE_FETCHING_URL) || (newState == STATE_CONNECTING)
        ...
        || (newState == STATE_PAUSED_BY_REQUEST) || (newState == STATE_PAUSED_WIFI_DISABLED_NEED_CELLULAR_PERMISSION)
